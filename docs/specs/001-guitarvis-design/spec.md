...
whatever Demucs writes — 16-bit stereo at the source sample rate, with no
resampling or downmix at this stage: stage 2 resamples internally and stage 3
downmixes to mono, so normalizing here would be redundant work on every job.
